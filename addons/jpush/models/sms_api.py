...
_jpush = jpush.JPush("f40ed7cee74e35bfb32662f4", "ab737fa7e21237211468d47d")
_jpush.set_logging("DEBUG")


class JpushApi(models.AbstractModel):
    _name = 'jpush.api'
    ...
    def _push(self,title,message):
        ...
        android = jpush.android(alert=title, priority=1, style=1, alert_type=1, big_text=message,
                                extras={'k1': 'v1'})

        push.notification = jpush.notification(alert=message, android=android)
