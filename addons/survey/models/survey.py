...
class SurveyUserInput(models.Model):
    ...
    user_id=fields.Many2one('res.user','调查人')
    location = fields.Char('调查地点')
...
class SurveyUserInputLine(models.Model):
    ...
    partner_id = fields.Many2one(related='user_input_id.partner_id',string='受调人')
    user_id = fields.Many2one(related='user_input_id.user_id', string='调查人')
    location = fields.Char(related='user_input_id.location', string='地点')
