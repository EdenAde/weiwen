...
var BarcodeParser = Class.extend({
    ...
    match_pattern: function (barcode, pattern, encoding){
     ...
     parse_barcode_with_type: function(barcode,type){
        var parsed_result = {
            encoding: '',
            type:'error',
            code:barcode,
        ...
        for (var i = 0; i < rules.length; i++) {
            ...
            console.log("-------------------")
            console.log(cur_barcode)
            console.log(rules[i].pattern)
            console.log(rule.encoding)
        ...
        for (var i = 0; i < rules.length; i++) {
            ...
            if (match.match) {
                if(rules[i].type === 'alias') {
                    ...
                    console.log("old_screen_name="+old_screen_name)

                    if(old_screen_name=="product"){
                        parsed_result.type ='client'
                    }
