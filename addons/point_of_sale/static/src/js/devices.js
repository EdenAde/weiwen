    ...
    scan: function(code){
        ...
        var type = 'product'
         var order = this.pos.get_order();
                    ...
                    console.log("11111old_screen_name="+old_screen_name)

                    if(old_screen_name=="clientlist"){
                        type ='client'
                    }



        var parsed_result = this.barcode_parser.parse_barcode_with_type(code,type);
        console.log("this.barcode_parser.parse_barcode(code)")
