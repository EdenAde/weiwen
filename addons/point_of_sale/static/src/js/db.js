...
var PosDB = core.Class.extend({
    ...
    get_product_by_barcode: function(barcode){
        console.log("this.product_by_barcode.length()="+this.product_by_barcode.length)
        console.log(this.product_by_barcode)
        if(this.product_by_barcode[barcode]){
            return this.product_by_barcode[barcode];
        } else {
           // this.get_book_from_server_with_barcode().then(function (data) {
           //     return data
           // })

           // this.get_book_from_server_with_barcode(barcode);
            return undefined;
        }
    },
    ...
    get_book_by_barcode: function(barcode){
        new Model('product.product').call('get_book_date_with_isbn',[1, barcode]).then(function(book){
