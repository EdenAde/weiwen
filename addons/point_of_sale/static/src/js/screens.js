...
var ScreenWidget = PosBaseWidget.extend({
    ...
    // get_product_book:function (code) {
    //     var p = new Promise(function(resolve, reject){
    //
    //         self.pos.scan_product(code)
    //     })
    // },
    ...
    barcode_product_action: function(code){
        ...
        self.pos.scan_product1(code).then(function (bvalue) {
        ...
        //
        //     alert('has-------');
        //    // self.show_book(book)9787040175950
        //
        //     console.log("self.barcode_product_screen"+self.barcode_product_screen)
        //     if (self.barcode_product_screen) {
        //         self.gui.show_screen(self.barcode_product_screen, null, null, true);
        //     }
        // }
        // else {
        //     alert('no');
        //    // self.get_book_from_server_with_barcode(code)
        //     self.show_book(code)
    ...
    barcode_client_action: function(code){
        console.log("barcode_client_action")
...
var ProductCategoriesWidget = PosBaseWidget.extend({
    ...
    init: function(parent, options){
        ...
        this.search_click_handler = function(event){
            //var selftis = this
            //alert(this)
            //console.log(self.$(event.target).prev().eq(0))
            //alert(self.el.querySelector('.searchbox input').value);
            self.pos.barcode_reader.scan(self.el.querySelector('.searchbox input').value);
           // if(event.type == "keypress" || event.keyCode === 46 || event.keyCode === 8){
           //      clearTimeout(search_timeout);
           //
           //      var searchbox = this;
    ...
    renderElement: function(){
        ...
        this.el.querySelector('.searchbox button').addEventListener('click',this.search_click_handler);
