...
class SelectColor(models.Model):
    ...
    range_start = fields.Integer(string='从(%)', required=True, help="Starting range of Statusbar in Percentage")
    range_stop = fields.Integer(string='到(%)', required=True, help="Stop range of Statusbar in Percentage")
    color = fields.Selection([('red', '红'), ('green', '绿'), ('yellow', '黄'),
                             ('pink', '粉'), ('orange', '橘'),
                             ('light_green', '浅绿'), ('grey', '灰'),
                              ('blue', '蓝'), ('purple', '紫'),
                              ('black', '黑'), ('brown', '棕')],
                             string='颜色', required=True, default='red',
