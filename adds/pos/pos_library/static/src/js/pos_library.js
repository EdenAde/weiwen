/**
 * Created by guizhouyuntushidai on 2017/8/8.
 */
odoo.define('pos_library.timerange', function (require) {
"use strict";



var fc = require('web.form_common')

var data = require('web.data');
var session = require('web.session');

fc.NotebookInvisibilityChanger.include({
