...
class Users(models.Model):
    ...
    def _is_admin(self):
        self.ensure_one()
        #print "_is_admin_is_admin_is_admin_is_admin_is_admin_is_admin"
        return self._is_superuser() or self.has_group('base.group_school_administration')

    @api.multi
    def _is_superuser(self):
        self.ensure_one()
        #print "_is_superuser_is_superuser_is_superuser_is_superuser_is_superuser"
        return self.id == SUPERUSER_ID or self.env.user.has_group('school.group_school_administration')
...
class UsersView(models.Model):
    ...
    def default_get(self, fields):
        ...
        fields1=[ u'company_id', u'fax', u'company_ids', u'name', u'email', u'login', u'image', u'phone', u'role_line_ids', u'id', u'mobile']
