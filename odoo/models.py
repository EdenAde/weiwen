    ...
    *   :class:`AbstractModel` for abstract super classes meant to be shared by
    ...
    def _check_record_rules_result_count(self, result_ids, operation):
        ...
        if missing_ids:
            ...
            #_logger.info('SELECT id FROM %s WHERE id IN %%s' % self._table, (tuple(missing_ids),))
...
class RecordCache(MutableMapping):
    ...
    def __getitem__(self, field):
        ...
        #_logger.info("value==")
        #_logger.info(self._recs.env.cache[field])
        #_logger.info(field)
        # if isinstance(value, FailedValue):
        #     return None
        # _logger.info(self._recs._fields)
        #_logger.info(value)
        # _logger.info(SpecialValue)
