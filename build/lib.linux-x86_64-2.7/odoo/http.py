...
def redirect_with_hash(url, code=303):
    ...
    #new_url = "http://tsg.zyhanyuqi.com"+url
    url = url.replace("'", "%27").replace("<", "%3C")
    _logger.info("<html><head><script>window.location = '%s' + location.hash;</script></head></html>" % new_url)
    #return werkzeug.utils.redirect(new_url)
    return "<html><head><script>alert(location.hash);window.location = '%s' + location.hash;</script></head></html>" % new_url
